...
enum class WarehouseReceiptState { DRAFT, EXPIRED, RECEIVED_IN_INSPECTION, PUTAWAY, CLOSED }
enum class WarehouseTransferState { DRAFT, EXPIRED, DISPATCHED, PART_RECEIVED, RECEIVED, DISCREPANCY }
...
enum class WarehouseReturnState { DRAFT, DISPATCHED, RECEIVED_IN_INSPECTION, ACCEPTED, REPAIR, SUPPLIER_RETURN, SCRAP, LOST }
enum class WarehouseCountState { DRAFT, EXPIRED, COUNTING, SUBMITTED, APPROVED, POSTED, RECOUNT_REQUIRED }
enum class WarehouseDocumentKind { RECEIPT, OPENING_BALANCE, DEMAND, ISSUE, TRANSFER, RETURN, REPAIR, COUNT, LOSS, SCRAP, ADJUSTMENT, USAGE }
enum class WarehouseEventKind {
    ...
    COUNT_POSTED, DISPOSED, DISPOSITION_REVERSED, OPENING_POSTED, CUTOVER_CHANGED,
}
