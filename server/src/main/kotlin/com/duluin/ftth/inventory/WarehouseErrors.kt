...
enum class WarehouseErrorCode(val httpStatus: Int) {
    ...
    INSUFFICIENT_STOCK(409), STALE_REVISION(409), SOURCE_NOT_VERIFIED(409), DRAFT_EXPIRED(409), WRONG_CUSTODIAN(409),
    ...
    MATERIAL_OBLIGATION_OUTSTANDING(409), MATERIAL_UNPICK_REQUIRED(409),
}
