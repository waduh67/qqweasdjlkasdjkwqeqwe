...
@RestControllerAdvice(assignableTypes = [WarehouseReplenishmentController::class, AssetTitleCorrectionController::class, InventoryController::class, MaterialTemplateController::class, WarehousePolicyController::class, InventoryApprovalController::class, WarehouseMasterController::class, WarehouseReceiptController::class, WarehouseOpeningBalanceController::class, WarehouseQueryController::class, InventoryQueryController::class, WarehouseReservationController::class])
