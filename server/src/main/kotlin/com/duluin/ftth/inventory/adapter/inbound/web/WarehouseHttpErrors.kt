...
@RestControllerAdvice(assignableTypes = [WarehouseReportController::class, WarehouseAssetLossController::class, WarehouseCompensationController::class, WarehouseDispositionController::class, WarehouseRmaHandoverController::class, WarehouseReturnController::class, WarehouseReplenishmentController::class, WarehouseCountController::class, WarehouseCountQueryController::class, WarehouseTransferController::class, AssetTitleCorrectionController::class, InventoryController::class, MaterialTemplateController::class, WarehousePolicyController::class, InventoryApprovalController::class, WarehouseMasterController::class, WarehouseReceiptController::class, WarehouseOpeningBalanceController::class, WarehouseQueryController::class, InventoryQueryController::class, WarehouseReservationController::class])
