...
@RestControllerAdvice(assignableTypes = [WarehouseMasterController::class, WarehouseReceiptController::class, WarehouseOpeningBalanceController::class, WarehouseQueryController::class, InventoryQueryController::class])
