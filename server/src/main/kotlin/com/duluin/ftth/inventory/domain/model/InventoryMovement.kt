...
enum class MovementKind {
    RESTOCK, RECEIVE, OPENING_BALANCE, RESERVE, RELEASE, ISSUE, ISSUE_EXCEPTION, TRANSFER, TRANSFER_RECEIPT, RETURN,
    REPAIR, QUARANTINE, ADJUSTMENT, LOSS, SCRAP, WRITE_OFF, COUNT_VARIANCE, DISPOSAL, CONSUME, REVERSAL, DEPLOY, TITLE_TRANSFER, TITLE_CORRECTION,
}
