...
enum class InventoryStatus {
    AVAILABLE, RESERVED, ISSUED, IN_TRANSIT, CONSUMED, RETURNED, QUARANTINE, LOST, DISPOSED, RECEIPT_SOURCE, CUSTOMER_INSTALLED
}
...
data class SerializedAsset(
    ...
    companion object {
        ...
        private fun isAllowed(from: InventoryStatus, to: InventoryStatus): Boolean = when (from) {
            ...
            InventoryStatus.CONSUMED, InventoryStatus.DISPOSED, InventoryStatus.RECEIPT_SOURCE, InventoryStatus.CUSTOMER_INSTALLED -> false
        }
    }
}
