...
@Repository
class WarehouseAssetLossStore(private val jdbc: WarehouseCommandJdbc, private val lifetime: WarehouseDraftLifetimeStore) {
    ...
    private fun currentView(view: WarehouseAssetLossView): WarehouseAssetLossView {
