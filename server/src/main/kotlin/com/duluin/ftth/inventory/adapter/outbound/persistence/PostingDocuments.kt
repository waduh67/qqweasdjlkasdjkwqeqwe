...
internal class PostingDocuments(private val sql: PostingSql) {
    ...
    fun events(command: WarehousePost, result: WarehousePostResult) {
        val kind = when(command.kind) {
            ...
            MovementKind.OPENING_BALANCE -> WarehouseEventKind.OPENING_POSTED
            MovementKind.RETURN -> WarehouseEventKind.RETURN_RECEIVED
            MovementKind.REPAIR -> if (command.nextState in setOf("REPAIR", "DISPATCHED")) WarehouseEventKind.DISPATCHED else WarehouseEventKind.RETURN_RECEIVED
            ...
            MovementKind.LOSS, MovementKind.SCRAP -> WarehouseEventKind.DISPOSED
            MovementKind.REVERSAL -> WarehouseEventKind.DISPOSITION_REVERSED
