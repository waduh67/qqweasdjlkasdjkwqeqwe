...
@RestControllerAdvice(assignableTypes = [MaterialWorkflowController::class, MaterialWorkbenchController::class, MyMaterialsController::class, MaterialReceiptController::class, MaterialUsageController::class, MaterialSettlementController::class, MaterialReworkController::class, CustomerAssetWorkflowController::class, AssetReplacementController::class])
