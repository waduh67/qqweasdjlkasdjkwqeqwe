...
@RestControllerAdvice(assignableTypes = [MaterialWorkflowController::class, MaterialReceiptController::class, MaterialUsageController::class, MaterialSettlementController::class])
