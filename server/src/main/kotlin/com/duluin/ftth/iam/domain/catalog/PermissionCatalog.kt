...
object PermissionCatalog {
    ...
    val ALL: List<PermissionDefinition> = buildList {
        ...
        perm("inventory.sku.view", "Lihat katalog SKU gudang")
        perm("inventory.sku.manage", "Kelola katalog SKU gudang")
        perm("inventory.receipt.view", "Lihat penerimaan gudang")
        ...
        perm("inventory.transfer.manage", "Kelola transfer gudang")
        perm("inventory.return.view", "Lihat retur dan inspeksi")
        perm("inventory.return.manage", "Kelola retur dan inspeksi")
        perm("inventory.count.view", "Lihat stock opname")
        perm("inventory.count.manage", "Kelola stock opname")
        perm("inventory.report.view", "Lihat laporan gudang")
        perm("inventory.cost.view", "Lihat biaya material")
        perm("inventory.provenance.view", "Lihat asal dan kepemilikan aset")
        perm("inventory.provenance.manage", "Rekonsiliasi asal dan kepemilikan aset")
