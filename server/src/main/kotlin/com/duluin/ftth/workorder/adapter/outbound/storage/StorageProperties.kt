...
/**
 * Konfigurasi object storage (S3/MinIO) tempat bukti pengerjaan disimpan.
 * MinIO S3-compatible, jadi klien AWS S3 cukup diarahkan lewat [endpoint] +
 * [pathStyleAccess] (MinIO tak mendukung virtual-host style secara default).
 */
