...
class WarehouseSchemaIT {
    ...
    fun `tenant parent foreign keys are composite`() {
        ...
        """.trimIndent())).contains("inventory_document_line", "inventory_reservation", "inventory_segment")
    }
    ...
    fun `posted outcomes and events have append only triggers`() {
        ...
        """.trimIndent())).contains("inventory_operation", "inventory_outbox", "inventory_inbox", "inventory_usage_snapshot")
    }
}
