        ...
        database.dataSource.connection.use { connection -> connection.createStatement().use { statement ->
            ...
            """.trimIndent()).use { rows ->
                ...
                while (rows.next()) {
                    ...
                    val assertion = if (rows.getString(1) in setOf("warehouse_consumed_truth_guard", "warehouse_fulfillment_bound_guard", "warehouse_fulfillment_owner_guard", "warehouse_residual_position_final_guard"))
