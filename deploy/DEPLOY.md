...
adalah **178.10**. Validasi seluruh checksum lama; bagian V166–V170 di bawah
...
Expected upgraded version is `178.10`; a clean database must reach the same version. Take
