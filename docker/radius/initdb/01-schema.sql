...
--
-- Ini skema resmi FreeRADIUS 3.x: radacct menampung akunting sesi (dari sinilah
-- adapter FreeRADIUS collector membaca sesi hidup), radcheck/radreply/rad*group*
-- menampung kredensial & atribut balasan, nas menampung daftar BRAS klien. Dijalankan
-- otomatis saat container radius-db pertama kali dibuat.
...
-- Sesi hidup = acctstoptime IS NULL; indeks parsial mempercepat justru query itu,
-- yang persis dipakai adapter collector tiap denyut.
...
-- Daftar BRAS klien; dibaca FreeRADIUS bila read_clients=yes pada modul sql.
