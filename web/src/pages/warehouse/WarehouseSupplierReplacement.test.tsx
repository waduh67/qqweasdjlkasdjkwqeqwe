...
it('creates only a draft then reloads its named receipt link while retaining customer ownership', async () => {
  ...
  fireEvent.click(screen.getByRole('button', { name: 'Tinjau usulan pengganti' }))
  ...
  fireEvent.click(screen.getByRole('button', { name: 'Catat usulan pengganti' }))
  ...
  expect(screen.getByText('Usulan pengganti sudah tercatat. Belum ada perangkat pengganti yang diterima.')).toBeTruthy()
