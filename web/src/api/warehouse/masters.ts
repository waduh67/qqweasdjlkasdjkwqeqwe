...
export const getSku = (id: string) => query(`/api/v1/warehouse/skus/${uuid(id)}`, sku)
export const getLocation = (id: string) => query(`/api/v1/warehouse/locations/${uuid(id)}`, location)
export const getSupplier = (id: string) => query(`/api/v1/warehouse/suppliers/${uuid(id)}`, supplier)
